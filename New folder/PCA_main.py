...
# setup data column
# 'Date','Open','High','Low','Close','Volume','Adj Close' -> columns
...
pd.plotting.scatter_matrix(data.loc[:, "V2":"V7"], diagonal="kde", figsize=(20, 15))
plt.show()

for i in range(2, 7):
    sns.lmplot(x="V" + str(i), y="V" + str(i + 1), data=data, hue="V1", fit_reg=False)

ax = data[["V2", "V3", "V4", "V5", "V6", "V7"]].plot(figsize=(20, 15))
ax.legend(loc='center left', bbox_to_anchor=(1, 0.5))

ax = data[["V2", "V3", "V4", "V5", "V6"]].plot(figsize=(20, 15))
ax.legend(loc='center left', bbox_to_anchor=(1, 0.5))

ax = data[["V3", "V4", "V5", "V6"]].plot(figsize=(20, 15))
ax.legend(loc='center left', bbox_to_anchor=(1, 0.5))

ax = data[[ "V4", "V5", "V6"]].plot(figsize=(20, 15))
ax.legend(loc='center left', bbox_to_anchor=(1, 0.5))

ax = data[["V5", "V6"]].plot(figsize=(20, 15))
ax.legend(loc='center left', bbox_to_anchor=(1, 0.5))
...
print("## cov_w:")
print(calc_within_groups_covariance(X.V3, X.V4, y))
...
print("## cov_b:")
print(calc_between_groups_covariance(X.V5, X.V6, y))
